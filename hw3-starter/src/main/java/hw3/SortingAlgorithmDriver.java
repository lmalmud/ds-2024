...
public class SortingAlgorithmDriver {
  ...
  protected List<SortingAlgorithm<String>> getSortingAlgorithms() {
    ...
    sorts.add(new hw3.sort.NullSort<>());
    sorts.add(new hw3.sort.GnomeSort<>());
    sorts.add(new hw3.sort.SelectionSort<>());
    sorts.add(new hw3.sort.BubbleSort<>());
    sorts.add(new hw3.sort.InsertionSort<>());
    return sorts;
  }
